            ...
            <b-tab href="#2" title="2. Nhập thông tin ngôn ngữ">
                <div class="row productedit">
                    <div class="col-md-8">
                        ...
                        <b-card class="mt-3 " header="Phần mở rộng">
                            <b-form class="form-horizontal">
                                <button type="button" @click="addPhanMoRong()">Thêm phần mở rộng</button>

                                <template v-for="(item,index) in phanMoRong">
                                    <b-form-group label="Tiêu đề phần mở rộng">
                                        <b-form-input placeholder="Tiêu đề phần mở rộng" v-model="item.name"
                                                      required></b-form-input>
                                    </b-form-group>
                                    <div v-for="(s,s_index) in item.sub">
                                        <div style="position:relative ;border:2px dashed #dcd6d6;padding:20px;margin:0" class="row">
                                            <div class="col-md-5">
                                                <b-form-group label="Tiêu đề">
                                                    <b-form-input label="Tiêu đề"
                                                                  type="text"
                                                                  placeholder="Tiêu đề"
                                                                  v-model="s.title"></b-form-input>
                                                </b-form-group>
                                            </div>
                                            <div class="col-md-4">
                                                <b-form-group label="Đường dẫn">
                                            ...
                                            <div class="col-md-2">
                                                <div style="cursor:pointer" @click="openImg_sub(s_index, index)">
                                                    <div style="width:100%;display:flex"
                                                         class="gallery-upload-file ui-sortable">
                                                        <div style="width:100%;height:auto;margin:0"
                                                             class=" r-queue-item ui-sortable-handle">
                                                            <div style="width:100%"
                                                                 v-if="s.avatar != null && s.avatar != undefined &&  s.avatar.length > 0">
                                                                <img alt="Ảnh lỗi" style="height:100px;width:100%"
                                                                     :src="pathImgs(s.avatar)">
                                                            </div>
                                                            <div v-else>
                                                                <i class="fa fa-picture-o"></i>
                                                                <p>[Chọn ảnh]</p>
                                        ...
                                        <div>
                                            <button type="button" @click="themSubMoRong(item)">+</button>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            DoAttackFile(value) {
                ...
                console.log(this.KeyPhanMoRong, this.KeySub)
                if (this.KeyPhanMoRong >= 0 && this.KeySub >= 0) {
                    this.phanMoRong[this.KeyPhanMoRong].sub[this.KeySub].avatar = value[0].path;
                }
            },
            getOrSetData(value) {
            ...
            DoAddEdit() {
                ...
                this.objRequest.phanMoRong = this.phanMoRong;
                ...
                if (this.ListArticleInLanguage != null) {
                    for (var i = 0; i < this.ListArticleInLanguage.length; i++) {
                        ...
                        if (node.id == this.ListArticleInLanguage[i].languageCode) {
                            ...
                            if (this.ListArticleInLanguage[i].phanMoRong != null) {
                                console.log("no ne")
                                console.log(this.ListArticleInLanguage[i].phanMoRong);

                                let p = this.ListArticleInLanguage[i].phanMoRong;
                                this.phanMoRong = p;
                            }
                            //
                            ...
                            this.objRequest.phanMoRong = this.ListArticleInLanguage[i].phanMoRong || this.phanMoRong;
            ...
            openImg_sub(s_index, index) {
                this.KeyPhanMoRong = index;
                this.KeySub = s_index;
            ...
            async getArticleByIds() {
                if (this.$route.params.id > 0) {
                    ...
                    //this.phanMoRong = Object.values(result.data.articleInLanguageViewModels.phanMoRong);
                    console.log(result.data.articleInLanguageViewModels[0].phanMoRong)
                    this.phanMoRong = Object.values(result.data.articleInLanguageViewModels[0].phanMoRong);
                    //
