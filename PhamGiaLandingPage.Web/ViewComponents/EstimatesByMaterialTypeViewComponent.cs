...
{
    public class EstimatesByMaterialTypeViewComponent : ViewComponent
    {
        ...
        public EstimatesByMaterialTypeViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
            _zoneRepository = zoneRepository;
            _productRepository = productRepository;
            _articleRepository = articleRepository;
        }
        public IViewComponentResult Invoke(int material_type)
        {
            ViewBag.MaterialType = material_type;
