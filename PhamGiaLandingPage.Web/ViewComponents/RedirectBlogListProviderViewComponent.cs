...
{
    public class RedirectBlogListProviderViewComponent : ViewComponent
    {
        ...
        public RedirectBlogListProviderViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
