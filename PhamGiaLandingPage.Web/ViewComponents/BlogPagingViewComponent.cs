...
namespace PhamGiaLandingPage.Web.ViewComponents
{
    public class BlogPagingViewComponent : ViewComponent
    {
        ...
        public BlogPagingViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
            _zoneRepository = zoneRepository;
            _productRepository = productRepository;
            _articleRepository = articleRepository;
        }
        public IViewComponentResult Invoke(string alias, int? pageIndex, int? pageSize, int total)
        {
