...
{
    public class RedirectBlogListCenterViewComponent : ViewComponent
    {
        ...
        public RedirectBlogListCenterViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
