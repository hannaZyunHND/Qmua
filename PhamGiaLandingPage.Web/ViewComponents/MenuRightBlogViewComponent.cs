...
{
    public class MenuRightBlogViewComponent : ViewComponent
    {
        ...
        public MenuRightBlogViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
