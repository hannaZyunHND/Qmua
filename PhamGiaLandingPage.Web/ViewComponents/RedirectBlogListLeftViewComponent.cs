...
{
    public class RedirectBlogListLeftViewComponent : ViewComponent
    {
        ...
        public RedirectBlogListLeftViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
            _zoneRepository = zoneRepository;
            _productRepository = productRepository;
            _articleRepository = articleRepository;
        }
        public IViewComponentResult Invoke(ZoneByTreeViewMinify minify, string target_url)
        {
            ViewBag.Url = target_url;
            return View(minify);
        }
    }
}
