...
namespace PhamGiaLandingPage.Web.ViewComponents
{
    public class BreadcrumbViewComponent : ViewComponent
    {
        ...
        public BreadcrumbViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
