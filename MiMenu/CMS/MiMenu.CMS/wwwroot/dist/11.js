...
exports.default = {
    ...
    created: function created() {
        ...
        this.getAllTypeContact().then(function (respose) {
            _this.ListType = respose.listData;
        });

        this.getAllStatusContact().then(function (respose) {
            try {

                _this.ListStatus = respose.listData;
            } catch (ex) {}
        });
    ...
    methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(["getContacts", "getAllTypeContact", "getAllStatusContact", "createContact", "removeContact", "updateStatusContact", "updateNoteContact"]), {
        format_date: function format_date(value) {
            if (value) {
                return (0, _moment2.default)(String(value)).format('DD/MM/YYYY HH:mm');
            }
        },
        urlView: function urlView(link) {

            return _helper.pathImg + link;
        },
        ...
        updateNote: function updateNote(item) {
            var _this2 = this;

            var initial = this.$route.query.initial;
            initial = typeof initial != "undefined" ? initial.toLowerCase() : "";
            item.modifiedBy = this.objUser.userName;
            this.updateNoteContact(item).then(function (response) {
        ...
        createContact: function createContact(item) {
            var _this3 = this;

            var initial = this.$route.query.initial;
            initial = typeof initial != "undefined" ? initial.toLowerCase() : "";
            this.createContact(item).then(function (response) {
                if (response.Success == true) {
                    _this3.$toast.success(response.Message, {});
                    _this3.$bvModal.hide('edit');
                    _this3.pageIndex = 1;
        ...
        updateStatus: function updateStatus(item, status) {
            ...
            var initial = this.$route.query.initial;
            initial = typeof initial != "undefined" ? initial.toLowerCase() : "";
            this.updateStatusContact(item).then(function (response) {
                if (response.Success == true) {
                    _this5.$toast.success(response.Message, {});
                    _this5.onChangePaging();
    ...
    computed: (0, _extends3.default)({}, (0, _vuex.mapGetters)(["contacts"])),
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._m(1), _vm._v(" "), _c('tbody', [_vm._l((_vm.contacts.listData), function(item) {
    return [_c('tr', {
      staticClass: "odd",
      attrs: {
        "role": "row"
    ...
    }, [_c('p', [_vm._v("Tên: " + _vm._s(item.name))])]), _vm._v(" "), _c('td', [(item.phone != null && item.phone.length > 0) ? _c('p', [_vm._v("Phone: " + _vm._s(item.phone))]) : _vm._e(), _vm._v(" "), _c('p', [_vm._v("Mail: " + _vm._s(item.email))])]), _vm._v(" "), _c('td', {
      domProps: {
    ...
    }, [_vm._v(" Xử lý")]) : _vm._e(), _vm._v(" "), (item.status == 3) ? _c('span', {
      staticClass: "badge bg-danger"
    }, [_vm._v(" Không xử lý")]) : _vm._e()]), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    ...
    model: {
      value: (_vm.objRequest.title),
      callback: function($$v) {
        _vm.$set(_vm.objRequest, "title", $$v)
      },
      expression: "objRequest.title"
    }
    ...
    on: {
      "change": function($event) {
        ...
        _vm.$set(_vm.objRequest, "status", $event.target.multiple ? $$selectedVal : $$selectedVal[0])
      }
    }
  }, _vm._l((_vm.ListStatus), function(item) {
    return _c('option', {
    ...
    on: {
      "click": function($event) {
        return _vm.updateNote(_vm.objRequest)
      }
    }
  }, [_vm._v("Cập nhật")])], 1)], 1)
  ...
  }, [_c('th'), _vm._v(" "), _c('th', [_vm._v("Tiêu đề")]), _vm._v(" "), _c('th', [_vm._v("Thông tin")]), _vm._v(" "), _c('th', [_vm._v("Liên hệ")]), _vm._v(" "), _c('th', [_vm._v("Ngày tạo")]), _vm._v(" "), _c('th', [_vm._v("Xem")]), _vm._v(" "), _c('th', {
    staticClass: "text-center"
