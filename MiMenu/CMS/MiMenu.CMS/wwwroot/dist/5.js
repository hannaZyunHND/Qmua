...
exports.default = (0, _defineProperty3.default)({
    ...
    data: function data() {
        return {
            ...
            objRequest: {
                ...
                ma: "",
                name: "",
                createDate: (0, _moment2.default)(String(new Date())).format('YYYY-MM-DD'),
                exprireDate: (0, _moment2.default)(String(new Date())).format('YYYY-MM-DD')
            },
            ListCoupon: [],
    ...
    methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(["MergeCouponChild", "DeleteCouponChild", "GetCouponsChildId", "getAllCoupon"]), {
        getAll: function getAll() {
            var _this = this;

            this.getAllCoupon().then(function (response) {
                _this.ListCoupon = response;
            });
        },
        ...
        GetById: function GetById() {
            ...
            if (this.$route.params.id != null && this.$route.params.id.length > 0) {
                this.GetCouponsChildId(this.$route.params.id).then(function (response) {
                    _this3.objRequest = response;
                    _this3.objRequest.createDate = (0, _moment2.default)(response.createDate).format('YYYY-MM-DD');
                    _this3.objRequest.exprireDate = (0, _moment2.default)(response.exprireDate).format('YYYY-MM-DD');
                });
            }
        },
        DoAddEdit: function DoAddEdit() {
            ...
            this.isLoading = true;
            this.MergeCouponChild(this.objRequest).then(function (response) {
                ...
                _this4.$toast.error("Lỗi" + ". Error:" + e, {});
            });
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.objRequest.parrent),
      expression: "objRequest.parrent"
    }],
    ...
    on: {
      "change": function($event) {
        ...
        _vm.$set(_vm.objRequest, "parrent", $event.target.multiple ? $$selectedVal : $$selectedVal[0])
      }
    }
  }, [_c('option', {
    attrs: {
  ...
  }, [_vm._v("Chọn nhóm")]), _vm._v(" "), _vm._l((_vm.ListCoupon), function(item) {
    return _c('option', {
      domProps: {
        "value": item.id
      }
    ...
    attrs: {
      "placeholder": "Nhập mã (Chú ý nếu sửa thì không nên chỉnh mã)",
      "required": ""
    },
    model: {
      value: (_vm.objRequest.ma),
      callback: function($$v) {
        _vm.$set(_vm.objRequest, "ma", $$v)
      },
      expression: "objRequest.ma"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
    ...
    model: {
      value: (_vm.objRequest.createDate),
      callback: function($$v) {
        _vm.$set(_vm.objRequest, "createDate", $$v)
      },
      expression: "objRequest.createDate"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
    staticClass: "col-md-6"
  }, [_c('b-form-group', {
    ...
    model: {
      value: (_vm.objRequest.exprireDate),
      callback: function($$v) {
        _vm.$set(_vm.objRequest, "exprireDate", $$v)
      },
      expression: "objRequest.exprireDate"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
    staticClass: "col-md-12"
  }, [_c('b-form-group', {
...
var update = __webpack_require__(777)("7245ecd1", content, true);
