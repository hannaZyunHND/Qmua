...
var fields = [{ key: "Check", label: "" }, { key: "Id", label: "STT" }, { key: "Code", label: "Mã giảm giá", sortable: true }, { key: "Name", label: "Mô tả" }, { key: "NumberOfUsed", label: "Số lần sử dụng", sortable: true }, { key: "QuantityDiscount", label: "Số lượng", sortable: true }, { key: "Status", label: "Trạng thái" }, { key: "StartDate", label: "Ngày bắt đầu", sortable: true }, { key: "EndDate", label: "Ngày kết thúc", sortable: true }, { key: "Action", label: "Thao tác" }];
exports.default = (0, _defineProperty3.default)({
    ...
    methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(["getCoupons", "unPublishCoupon"]), {
        unpublish: function unpublish(id, type) {
            var _this = this;
            ...
            if (confirm("Bạn có thực sự muốn hạ mã coupon?")) {
                this.unPublishCoupon(item).then(function (response) {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 5;
                                return _this2.getCoupons({
                                    initial: initial,
                                    pageIndex: _this2.currentPage,
                                    pageSize: _this2.pageSize,
                                    keyword: _this2.searchTitle
                                });

                            case 5:
                                _this2.listCoupon = _context.sent;

                                console.log(_this2.listCoupon);
                                _this2.totalRow = _this2.listCoupon.totalRow;
                                _this2.items = _this2.listCoupon.items;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("Tìm kiếm")])], 1)], 1)], 1)], 1)]), _vm._v(" "), _c('b-card', [_c('div', {
    staticClass: "mb-2",
    attrs: {
      "role": "toolbar",
  ...
  }), _vm._v(" Xóa")])], 1), _vm._v(" "), _c('b-dropdown', {
    staticClass: "mx-1",
    attrs: {
      "variant": "info",
      "right": "",
  ...
  }), 0)]), _vm._v(" "), _c('tbody', _vm._l((this.items), function(item, index) {
    return _c('tr', [_c('td', [_c('b-form-checkbox')], 1), _vm._v(" "), _c('td', {
      ...
      staticClass: "text-center"
    }, [_vm._v("\n                            " + _vm._s(item.numberOfUsed) + "\n                        ")]), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    }, [_vm._v("\n                            " + _vm._s(item.quantityDiscount) + "\n                        ")]), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    }, [(item.locked == 1) ? _c('span', {
      staticClass: "badge bg-danger"
    }, [_vm._v("Hủy")]) : _vm._e(), _vm._v(" "), (item.locked == 0) ? _c('span', {
      staticClass: "badge bg-success"
    }, [_vm._v("Áp dụng")]) : _vm._e()]), _vm._v(" "), _c('td', {
      staticClass: "text-center",
      domProps: {
        "innerHTML": _vm._s(_vm.format_date(item.startDate))
      }
    }), _vm._v(" "), _c('td', {
      staticClass: "text-center",
      domProps: {
        "innerHTML": _vm._s(_vm.format_date(item.endDate))
      }
    }), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    }, [_c('router-link', {
      ...
      on: {
        "click": function($event) {
          return _vm.unpublish(item.id, 1)
        }
      }
    }, [_c('i', {
      ...
      on: {
        "click": function($event) {
          return _vm.unpublish(item.id, 2)
        }
      }
    }, [_c('i', {
      staticClass: "fa fa-trash-o",
