...
var fields = [{ key: "Check", label: "" }, { key: "Id", label: "STT" }, { key: "Ma", label: "Mã giảm giá", sortable: true }, { key: "Name", label: "Tên" }, { key: "Nhom", label: "Nhóm" }, { key: "SoLanSuDung", label: "Số lần sử dụng" }, { key: "DoanhThu", label: "Doanh thu" }, { key: "CreateDate", label: "Ngày tạo", sortable: true }, { key: "ExprireDate", label: "Ngày kết thúc", sortable: true }, { key: "Status", label: "Trạng thái" }, { key: "Action", label: "Thao tác" }];
exports.default = (0, _defineProperty3.default)({
    ...
    methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(["getCouponsChild", "PublishCouponChild", "getAllCoupon"]), {
        getAll: function getAll() {
            var _this = this;

            this.getAllCoupon().then(function (response) {
                _this.ListCoupons = response;
            });
        },
        publish: function publish(item, type) {
            var _this2 = this;

            if (confirm("Bạn có thực sự muốn thay đổi trạng thái coupon?")) {
                item.status = type;
                this.PublishCouponChild(item).then(function (response) {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 5;
                                return _this3.getCouponsChild({
                                    initial: initial,
                                    pageIndex: _this3.currentPage,
                                    pageSize: _this3.pageSize,
                                    keyword: _this3.searchTitle,
                                    parrent: _this3.SearchParrent,
                                    status: _this3.SearchStatus
                                });

                            case 5:
                                _this3.ObjRequest = _context.sent;
        ...
        remove: function remove(item) {
            ...
            if (confirm("Bạn có thực sự muốn xoá?")) {
                _manufacturerRepository2.default.deleteManufacturers(item).then(function (response) {
    ...
    watch: {
        ...
        SearchParrent: function SearchParrent() {
            this.onChangePaging();
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "click": this.onChangePaging
    }
  }, [_vm._v("Tìm kiếm")])], 1), _vm._v(" "), _c('b-col', {
    attrs: {
      "md": "2"
    }
  }, [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.SearchParrent),
      expression: "SearchParrent"
    }],
    ...
    on: {
      "change": function($event) {
        ...
        _vm.SearchParrent = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    attrs: {
  ...
  }, [_vm._v("Chọn nhóm")]), _vm._v(" "), _vm._l((_vm.ListCoupons), function(item) {
    return _c('option', {
      domProps: {
        "value": item.id
      }
  ...
  }, [_vm._v("Đang xuất bản")]), _vm._v(" "), _c('option', {
    attrs: {
      "value": "2"
    }
  }, [_vm._v("Đang hạ")])])])], 1)], 1)], 1)]), _vm._v(" "), _c('b-card', [_c('div', {
    staticClass: "mb-2",
    attrs: {
      "role": "toolbar",
  ...
  }), _vm._v(" Xóa ss")])], 1), _vm._v(" "), _c('b-dropdown', {
    staticClass: "mx-1",
    attrs: {
      "variant": "info",
      "right": "",
    ...
    attrs: {
      "total-rows": _vm.ObjRequest.totals,
  ...
  }), 0)]), _vm._v(" "), _c('tbody', _vm._l((_vm.ObjRequest.data), function(item, index) {
    return _c('tr', [_c('td', [_c('b-form-checkbox')], 1), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    }, [_vm._v("\n                            " + _vm._s(index + 1) + "\n                        ")]), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    }, [_vm._v("\n                            " + _vm._s(item.ma) + " \n                        ")]), _vm._v(" "), _c('td', {
      ...
      staticClass: "text-center"
    }, [_vm._v(_vm._s(item.nhom))]), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    }, [_vm._v(_vm._s(item.soLanSuDung))]), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    }, [_vm._v(_vm._s(item.doanhSo))]), _vm._v(" "), _c('td', {
      staticClass: "text-center",
      domProps: {
        "innerHTML": _vm._s(_vm.format_date(item.createDate))
      }
    }), _vm._v(" "), _c('td', {
      staticClass: "text-center",
      domProps: {
        "innerHTML": _vm._s(_vm.format_date(item.exprireDate))
      }
    }), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    }, [(item.status == 1) ? _c('span', {
      staticClass: "badge bg-success"
    }, [_vm._v("Áp dụng")]) : _vm._e(), _vm._v(" "), (item.status == 2) ? _c('span', {
      staticClass: "badge bg-warning"
    }, [_vm._v("Hủy")]) : _vm._e(), _vm._v(" "), (item.status == 3) ? _c('span', {
      staticClass: "badge bg-danger"
    }, [_vm._v("Xóa")]) : _vm._e()]), _vm._v(" "), _c('td', {
      staticClass: "text-center"
    }, [_c('router-link', {
      attrs: {
        "to": {
