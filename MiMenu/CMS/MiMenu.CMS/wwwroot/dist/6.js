...
exports.default = {
    ...
    watch: {},
    methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(["addCoupon", "updateCoupon", "getCouponById", "uploadFile", "getProductInCoupon", "addProductInCoupon"]), {
        ...
        addProduct: function addProduct() {
            for (var i = 0; i < this.SearchProductId.length; i++) {
                ...
                var obj = this.ListProduct.filter(function (x) {
                    return x.id == searItem;
                });
        ...
        addProductInCoupons: function addProductInCoupons() {
            var _this2 = this;

            var obj = {};
            obj.lstObj = this.ListProductInCoupon;
            obj.id = this.objRequest.id;
            this.addProductInCoupon(obj).then(function (response) {
                ...
                _this2.$toast.error("Lỗi" + ". Error:" + e, {});
            });
        },
        ...
        getProduct: function getProduct(ma) {
            var _this3 = this;

            this.getProductInCoupon(ma).then(function (response) {

                _this3.ListProductInCoupon = response.ListData;
                _this3.ListProduct = response.ListProduct;
            });
        },
        GetById: function GetById() {
            ...
            return (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2() {
                var id, initial, response;
                return _regenerator2.default.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                if (!(_this4.$route.params.id > 0)) {
                                    _context2.next = 16;
                                    break;
                                }
                                ...
                                initial = _this4.$route.query.initial;

                                initial = typeof initial != "undefined" ? initial.toLowerCase() : "";
                                _context2.next = 8;
                                return _this4.getCouponById(id);

                            case 8:
                                response = _context2.sent;


                                _this4.objRequest = response;
                                _this4.objRequest.id = response.id;
                                _this4.CouponValues = response.discountOption;
                                _this4.objRequest.startDate = (0, _moment2.default)(response.startDate).format('YYYY-MM-DD');
                                _this4.objRequest.endDate = (0, _moment2.default)(response.endDate).format('YYYY-MM-DD');

                                _this4.getProduct(id);
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                _this5.objRequest.category = _this5.SearchZoneId;

                                if (!(_this5.objRequest.id > 0)) {
                                    _context3.next = 9;
                                    break;
                                }

                                _context3.next = 5;
                                return _this5.updateCoupon(_this5.objRequest);

                            case 5:
                                result = _context3.sent;

                                if (result.success == true) {
                                    _this5.$toast.success("Tạo thành công", {});
                                    _this5.isLoading = false;
                                } else {
                                    _this5.$toast.error(result.message, {});
                                    _this5.isLoading = false;
                                }
                                _context3.next = 13;
                                break;
                            ...
                            case 9:
                                _context3.next = 11;
                                return _this5.addCoupon(_this5.objRequest);
                            ...
                            case 11:
                                ...
                                if (result.success == true) {
                                    _this5.$toast.success("Tạo thành công", {});
                                    _this5.isLoading = false;
                                    _this5.objRequest.id = result.id;
                                    _this5.$router.push({
                                        path: "/admin/coupon/edit/" + result.id
                                    });
                                    _this5.getProduct(result.id);
                                } else {
        ...
        getSelectedCoupon: function getSelectedCoupon(node, id) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "title": "1. Nhập thông tin mã giảm giá",
      "active": ""
    }
  }, [_c('div', {
    ...
    on: {
      "select": _vm.getSelectedCoupon
    },
    model: {
      value: (_vm.CouponValues),
      callback: function($$v) {
        _vm.CouponValues = $$v
      },
      expression: "CouponValues"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
    staticClass: "col-md-6"
  }, [_c('b-form-group', {
    ...
    model: {
      value: (_vm.objRequest.quantityDiscount),
      callback: function($$v) {
        _vm.$set(_vm.objRequest, "quantityDiscount", $$v)
      },
      expression: "objRequest.quantityDiscount"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
    ...
    model: {
      value: (_vm.objRequest.valueDiscount),
      callback: function($$v) {
        _vm.$set(_vm.objRequest, "valueDiscount", $$v)
      },
      expression: "objRequest.valueDiscount"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
    staticClass: "col-md-4"
  }, [_c('b-form-group', {
    ...
    staticClass: "mt-3",
    attrs: {
      "header": "Danh sách sản phẩm áp dụng 1"
    }
  }, [_c('div', {
    staticClass: "row"
  }, [_c('div', {
    ...
    attrs: {
      "multiple": true,
      "flat": true,
      "options": _vm.ListProduct,
      "placeholder": "Mời bạn chọn sản phẩm"
    },
    model: {
      value: (_vm.SearchProductId),
      callback: function($$v) {
        _vm.SearchProductId = $$v
      },
      expression: "SearchProductId"
    }
  })], 1), _vm._v(" "), _c('div', {
    ...
    staticClass: "table table-centered table-nowrap data-thumb-view dataTable no-footer"
  }, [_c('thead', {
    staticClass: "thead-dark table table-centered table-nowrap text-center"
  }, [_c('tr', [_c('th', [_vm._v(" Tên sản phẩm sds ")]), _vm._v(" "), _c('th', [_vm._v(" Giá trị áp dụng ")]), _vm._v(" "), _c('th', [_vm._v(" Loại ")]), _vm._v(" "), _c('th', [_vm._v(" XXX ")])])]), _vm._v(" "), _c('tbody', {
    staticClass: "text-center"
  }, _vm._l((_vm.ListProductInCoupon), function(item, index) {
    return _c('tr', [_c('td', [_vm._v(_vm._s(item.name))]), _vm._v(" "), _c('td', [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: (item.value),
    ...
    }, _vm._l((_vm.CouponCodes), function(i) {
      return _c('option', {
        domProps: {
          "value": i.id
        }
      }, [_vm._v("\n                                                " + _vm._s(i.label) + "\n                                            ")])
    }), 0)]), _vm._v(" "), _c('td', [_c('span', {
    ...
    on: {
      "click": function($event) {
        _vm.addProductInCoupons()()
      }
    }
  }, [_c('i', {
    staticClass: "fa fa-save"
  }), _vm._v(" Thêm mã giảm giá cho sản phẩm\n                                ")])])])])], 1)])])], 1)], 1)
},staticRenderFns: []}
...
var update = __webpack_require__(777)("2aef5a34", content, true);
