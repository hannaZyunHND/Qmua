...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            loading: true,
            objRequest: {
                startTime: (0, _moment2.default)(String(new Date())).format('YYYY-MM-DD'),
                endTime: (0, _moment2.default)(String(new Date())).format('YYYY-MM-DD')
            },
            objRequestDetail: {},
            ListValue: [],
            langSelected: "",
    ...
    mounted: function mounted() {
        ...
        if (this.$route.params.id > 0) {
            ...
            this.getFlashSale(this.$route.params.id).then(function (respose) {
                _this.objRequest = respose.data;
                _this.objRequest.startTime = (0, _moment2.default)(String(_this.objRequest.startTime)).format('YYYY-MM-DD');
                _this.objRequest.endTime = (0, _moment2.default)(String(_this.objRequest.endTime)).format('YYYY-MM-DD');
                if (respose.listData != null && respose.listData.length > 0) {
                    _this.ListValue = respose.listData.map(function (item) {
    ...
    computed: (0, _extends3.default)({}, (0, _vuex.mapGetters)(["promotion"])),

    methods: (0, _extends3.default)({}, (0, _vuex.mapActions)(["getFlashSale", "getZones", "getProductForCombo", "createFlashSale"]), {
        ...
        onetoRight: function onetoRight() {
            ...
            var lstChose = this.ListProduct.filter(function (x) {
                ...
                return {
                    ...
                    avatar: item.avatar,
                    code: item.code,
                    flashSaleId: _this3.objRequest.id,
                    name: item.name,
                    productId: item.id,
            ...
            this.ListValue = [].concat((0, _toConsumableArray3.default)(lstChose), (0, _toConsumableArray3.default)(this.ListValue));
        },
        ...
        addFlashSale: function addFlashSale() {
            var _this4 = this;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    model: {
      value: (_vm.objRequest.startTime),
      callback: function($$v) {
        _vm.$set(_vm.objRequest, "startTime", $$v)
      },
      expression: "objRequest.startTime"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
    staticClass: "col-md-4"
  }, [_c('b-form-group', {
    ...
    model: {
      value: (_vm.objRequest.endTime),
      callback: function($$v) {
        _vm.$set(_vm.objRequest, "endTime", $$v)
      },
      expression: "objRequest.endTime"
    }
  })], 1)], 1)])]), _vm._v(" "), _c('div', {
    staticClass: "row"
  }, [_c('div', {
    ...
    return _c('li', {
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: (item.productPriceInFlashSale),
        expression: "item.productPriceInFlashSale"
      }],
      staticClass: "form-control",
      attrs: {
        "type": "number",
      ...
      on: {
        "input": function($event) {
          if ($event.target.composing) { return; }
          _vm.$set(item, "productPriceInFlashSale", $event.target.value)
        }
      }
    })]), _vm._v(" "), _c('div', {
      staticClass: "col-md-5"
...
var update = __webpack_require__(777)("53355d30", content, true);
