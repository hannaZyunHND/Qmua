...
namespace TemplateKAO.ViewComponents
{
    public class FilterSpectificationInZoneViewComponent : ViewComponent
    {
        ...
        public FilterSpectificationInZoneViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
