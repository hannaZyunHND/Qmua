...
namespace TemplateKAO.ViewComponents
{
    public class SEO_BreadcrumbViewComponent : ViewComponent
    {
        ...
        public SEO_BreadcrumbViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
            _zoneRepository = zoneRepository;
            _productRepository = productRepository;
            _articleRepository = articleRepository;
        }
        public IViewComponentResult Invoke(List<ZoneByTreeViewMinify> bread, string page, string type_page)
        {
            if (bread != null)
            {
