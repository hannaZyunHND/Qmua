...
{
    public class StoreListHTMLViewComponent : ViewComponent
    {
        ...
        public StoreListHTMLViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
