...
{
    public class SEO_SiteLinkSearchViewComponent : ViewComponent
    {
        ...
        public SEO_SiteLinkSearchViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
