...
{
    public class ProductLastSeenViewComponent : ViewComponent
    {
        ...
        public ProductLastSeenViewComponent(IZoneRepository zoneRepository, IProductRepository productRepository, IArticleRepository articleRepository)
        {
        ...
        {
            ViewBag.Product_Ids = product_ids;
            return View();
        }
    }
}
